...
void handle_sigint(int sig) {
    printf("\nРодительский процесс: Обработано %d наборов данных. Завершаю работу.\n", processed_sets);
...
void generate_data() {
    ...
    printf("Родительский процесс: Сгенерирован набор из %d чисел: ", shm_ptr->count);
    for (int i = 0; i < shm_ptr->count; i++) {
...
void print_results() {
    printf("Родительский процесс: Минимальное число: %d\n", shm_ptr->min);
    printf("Родительский процесс: Максимальное число: %d\n", shm_ptr->max);
}
...
void process_data() {
    ...
    printf("Дочерний процесс: Обработаны данные. Минимальное число: %d, Максимальное число: %d\n", min, max);
